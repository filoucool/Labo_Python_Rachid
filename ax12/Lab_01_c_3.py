...
class Ax12:
    ...
    def setLedAlarm(self, id, alarm):
        ...
        outData += chr(Ax12.AX_START)
        outData += chr(id)
        outData += chr(Ax12Ax12.AX_LEDALARM_LENGTH)
        outData += chr(Ax12.AX_WRITE_DATA)
...
while i<900:
    ...
    time.sleep(delay_0)
    ax12_o.Speed(dynamixel_id2, i)
    time.sleep(0.1)

i=0
while i<900:
    i = i+8
    ax12_o.Speed(dynamixel_id1, 1023-i)
    time.sleep(delay_0)
    ax12_o.Speed(dynamixel_id2, 1023-i)
    time.sleep(0.1)
